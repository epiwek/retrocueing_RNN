...
import constants
# import constants_expt1 as constants
...
if eval_flag:
    ...
    if constants.PARAMS['cue_validity'] < 1:
        # valid trials
        test_data_valid_trials = dg.subset_of_trials(test_data,
        ...
        test_data_invalid_trials = dg.subset_of_trials(test_data,
    ...
    for m in np.arange(constants.PARAMS['n_models']):
        ...
        if constants.PARAMS['cue_validity'] < 1:
            ...
            retnet.eval_model(model,test_data_valid_trials,constants.PARAMS,valid_path)
            
            # invalid
            eval_data,pca_data,rdm_data,model_outputs = \
            retnet.eval_model(model,test_data_invalid_trials,constants.PARAMS,invalid_path)
...
# _ = rg.get_cued_subspaces_indivModels(constants)
#%% analysis pipeline
if analysis_flag:
