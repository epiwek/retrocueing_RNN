...
PARAMS['experiment'] = 'Buschman_paradigm'
...
PARAMS['trial_timings']['delay2_dur'] = 0
...
# noise params
PARAMS['sigma'] = 0.1 # scaling factor for noise (boundary if uniform, s.d. if normal)
...
PARAMS['conv_criterion']['thr_slope'] = -5e-05 # threshold for the dLoss/dt value
PARAMS['conv_criterion']['thr_loss'] = 0.004 # threshold for the loss value
...
PARAMS['COND_PATH'] = PARAMS['BASE_PATH'] + 'data_vonMises/MSELoss_custom/Buschman_paradigm/'\
     + 'retrocue_timing/delay2_' + str(PARAMS['trial_timings']['delay2_dur']) + 'cycles/'
