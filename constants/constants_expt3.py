...
This is the configuration file for Experiment 3. To run the experiment, pass the path to the folder which is to contain
the data from all Experiments on lines 176-177.
