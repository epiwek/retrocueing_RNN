...
This is the configuration file for Experiment 4, cue validity 0.5, AI vs learning speed analysis. It differs from the
main Experiment 4, cue validity 0.5 configuration file in just one aspect - it is set to train more (N=100) models.
