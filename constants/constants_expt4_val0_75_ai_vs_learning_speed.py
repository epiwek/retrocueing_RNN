...
This is the configuration file for Experiment 4, cue validity 0.75, AI vs learning speed analysis. It differs from the
main Experiment 4, cue validity 0.75 configuration file in just one aspect - it is set to train more (N=100) models.

To run the experiment, pass the path to the folder which is to contain the data from all Experiments on lines 198-199.
@author: emilia
"""
import numpy as np
import itertools
...
PARAMS['expt_key'] = 'expt_4_cue_val_0.75'
